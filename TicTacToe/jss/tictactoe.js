...
let activePlayer = 'X';
//This array stores an array of moves. Its used to determine win conditions
let selectedSquares = [];

//This function is used for placing an x or o in a square
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // This condition checks to see whose turn it is
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the x.png is placed in HTML
            
            select.style.backgroundImage = 'url("images/Jerry.jpg")';
            select.style.backgroundSize = "188px";
            // Active player may only be 'X' or 'O' so- if not X it must be O

        } else {
            //If activePlayer is equal to O- the o.png is placed in HTML 
            select.style.backgroundImage = 'url("images/Newman.jpg")';
            select.style.backgroundSize = "188px";
        }
        // SquareNumber & activePlayer are concatenated together & added to array
        ...
        // This function plays punch sound
        audio('./media/punch.mp3');
        //This condition checks to see if it's the computers turn
        if (activePlayer === 'O') {
            //This function disables clicking when its the computers turn
            disableClick();
...
function checkWinConditions() {
    ...
    // This condition checks for a tie.  If none of the above conditions r met & 
    // 9 squares r selected the code executes
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        //These 3 variables will b used to check for 3 in a row
        const a = selectedSquares.includes(squareA);
        const b = selectedSquares.includes(squareB);
        const c = selectedSquares.includes(squareC);
        //If the 3 variables we pass are all included in our array then 
        //true is returned & our else if condition executes the drawLine function
...
function audio(audioURL) {
    //Creates a new audio object and pass the path in as a parameter
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //Shows where the start of lines y axis is
        y1 = coordY1,
        // Shows where the end of a lines x axis is
        x2 = coordX2,
        //Shows where the end of a lines y axis is
        y2 = coordY2,
        //This var stores temporary x axis data that is updated in the aniation loop
        x = x1,
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1);
        //This method indictes the end point in the line
        c.lineTo(x, y);
    ...
    animateLineDrawing();
    //This line waits 1 second. Then it clears canvas, resets game and allows clicking again
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //This removed our elements backgroundImage
